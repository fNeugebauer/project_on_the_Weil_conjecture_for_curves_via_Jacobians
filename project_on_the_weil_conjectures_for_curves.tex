...
%	\end{tabular}
	\begin{abstract}
		The most straightforward way to prove the Weil conjectures for a curve $C$ over a finite field $k$ is via intersection theory on the surface $C\times C$ as in \cite[V Exerc. 1.10]{hartshorne2013algebraic}. 
